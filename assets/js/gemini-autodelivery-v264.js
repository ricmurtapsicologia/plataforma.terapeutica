...
document.addEventListener('rm:workspace-auto-renew',e=>{if(e.detail?.status==='renewed')emit('workspace-ready','Workspace renovado; aguardando Dados ✓ para entregar prontuários.')});
window.addEventListener('online',()=>document.dispatchEvent(new CustomEvent('rm:workspace-auto-renew-request',{detail:{reason:'online'}})));
