...
function signature(list){return list.map(a=>[a.id,a.updatedAt||'',a.date||'',a.time||'',a.duration||'',a.status||'',a.attendanceStatus||'',a.patientId||'',calendarPatientName(patientById(a.patientId))].join('|')).sort().join('\n')}
