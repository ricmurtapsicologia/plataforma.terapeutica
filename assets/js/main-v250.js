...
async function normalizeAuditedDrafts(){
  try{
    const [{data,runtime,nowISO},{putEncrypted}]=await Promise.all([import('./state.js?v=3.7.5&rev=icaps-v400-20260902'),import('./database.js?v=3.7.5&rev=icaps-v400-20260902')]);
