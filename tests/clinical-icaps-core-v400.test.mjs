import test from 'node:test';import assert from 'node:assert/strict';import {QUESTION_HEADERS,DIMENSIONS,scoreRow,bindPatientExact,FIELD} from '../assets/js/clinical-icaps-core-v400.mjs';
...
test('all 3 => fifty',()=>scoreRow(row(3)).dimensions.forEach(d=>assert.equal(d.score,50)));
