...
const recordPersistence=read('assets/js/record-persistence-v321.js');
...
assert.ok(main.includes('record-persistence-v321.js'),'verified record persistence v321 must be active');
...
assert.ok(recordPersistence.includes('repairMissedRecordSyncOnce'),'record persistence must backfill the dirty signal for records saved before v321');
